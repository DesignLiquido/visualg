...
import tiposDeSimbolosDelegua from '@designliquido/delegua/tipos-de-simbolos/delegua';
...
export class TradutorReversoVisuAlg {
    ...
    traduzirSimboloOperador(operador: SimboloInterface): string {
        switch (operador.tipo) {
            case tiposDeSimbolosDelegua.ADICAO:
                return '+';
            case tiposDeSimbolosDelegua.BIT_AND:
                return '&';
            ...
            case tiposDeSimbolosDelegua.BIT_NOT:
                return '~';
            case tiposDeSimbolosDelegua.DIFERENTE:
                return '!=';
            case tiposDeSimbolosDelegua.DIVISAO:
                return '/';
            case tiposDeSimbolosDelegua.E:
                return 'e';
            case tiposDeSimbolosDelegua.EXPONENCIACAO:
                return '**';
            case tiposDeSimbolosDelegua.IGUAL:
                return '=';
            case tiposDeSimbolosDelegua.IGUAL_IGUAL:
                return '==';
            case tiposDeSimbolosDelegua.MAIOR:
                return '>';
            case tiposDeSimbolosDelegua.MAIOR_IGUAL:
                return '>=';
            case tiposDeSimbolosDelegua.MENOR:
                return '<';
            case tiposDeSimbolosDelegua.MENOR_IGUAL:
                return '<=';
            case tiposDeSimbolosDelegua.MODULO:
                return '%';
            case tiposDeSimbolosDelegua.MULTIPLICACAO:
                return '*';
            case tiposDeSimbolosDelegua.OU:
                return 'ou';
            case tiposDeSimbolosDelegua.SUBTRACAO:
                return '-';
        }
    }
